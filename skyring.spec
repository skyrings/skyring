...
install -Dm 0644 conf/sample/skyring-web.conf.sample $RPM_BUILD_ROOT/etc/skyring/httpd/conf.d/skyring-web.conf
...
%config(noreplace) %attr(644,root,root) %{_sysconfdir}/skyring/httpd/conf.d/skyring-web.conf
