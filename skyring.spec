...
install -D skyring-setup.sh $RPM_BUILD_ROOT/usr/sbin/skyring-setup.sh
...
%post
ln -fs RPM_BUILD_ROOT/usr/sbin/skyring-setup.sh RPM_BUILD_ROOT/usr/bin/skyring-setup.sh
...
%attr(0755, root, root) /usr/sbin/skyring-setup.sh
%{_sysconfdir}/skyring/*
