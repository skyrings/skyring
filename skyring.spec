...
install -Dm 0644 skyring-setup.sh $RPM_BUILD_ROOT/usr/share/skyring/setup/skyring-setup.sh
...
chmod a+x $RPM_BUILD_ROOT%{python2_sitelib}/skyring/__init__.py
chmod a+x $RPM_BUILD_ROOT%{python2_sitelib}/skyring/saltwrapper.py
