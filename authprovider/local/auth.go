...
type AuthBackend interface {
	...
	User(username string) (user model.User, e error)
	Users() (users []model.User, e error)
...
func (a Authorizer) AddUser(user model.User, password string) error {
	if user.Username == "" {
...
func (a Authorizer) UpdateUser(req *http.Request, username string, p string, e string) error {
	...
	newuser := model.User{Username: username, Email: email, Hash: hash, Role: user.Role}
...
// the information.
func (a Authorizer) GetUser(u string) (user model.User, e error) {
...
func (a Authorizer) ListUsers() (users []model.User, err error) {
