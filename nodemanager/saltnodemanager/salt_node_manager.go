...
func (a SaltNodeManager) ConfigureCollectdPhysicalResources(master string, node string) (bool, error) {
	return salt_backend.ConfigureCollectdPhysicalResources(node, map[string]string{"master_name": master})
}
