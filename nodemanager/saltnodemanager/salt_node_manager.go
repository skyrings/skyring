...
func (a SaltNodeManager) ServiceCount(hostname string, ctxt string) (map[string]int, error) {
	if Service_Count, err := salt_backend.ServiceCount(hostname, ctxt); err != nil {
