...
func (a *App) POST_Clusters(w http.ResponseWriter, r *http.Request) {
	...
	if taskId, err := a.GetTaskManager().Run(models.ENGINE_NAME, fmt.Sprintf("Create Cluster: %s", request.Name), asyncTask, 7200*time.Second, nil, nil, nil); err != nil {
...
func (a *App) Forget_Cluster(w http.ResponseWriter, r *http.Request) {
	...
	if taskId, err := a.GetTaskManager().Run(models.ENGINE_NAME, fmt.Sprintf("Forget Cluster: %s", cluster_id), asyncTask, 120*time.Second, nil, nil, nil); err != nil {
...
func (a *App) Unmanage_Cluster(w http.ResponseWriter, r *http.Request) {
	...
	if taskId, err := a.GetTaskManager().Run(models.ENGINE_NAME, fmt.Sprintf("Unmanage Cluster: %s", cluster_id_str), asyncTask, 120*time.Second, nil, nil, nil); err != nil {
...
func (a *App) Manage_Cluster(w http.ResponseWriter, r *http.Request) {
	...
	if taskId, err := a.GetTaskManager().Run(models.ENGINE_NAME, fmt.Sprintf("Manage Cluster: %s", cluster_id_str), asyncTask, 120*time.Second, nil, nil, nil); err != nil {
...
func (a *App) Expand_Cluster(w http.ResponseWriter, r *http.Request) {
	...
	if taskId, err := a.GetTaskManager().Run(models.ENGINE_NAME, fmt.Sprintf("Expand Cluster: %s", cluster_id_str), asyncTask, 7200*time.Second, nil, nil, nil); err != nil {
