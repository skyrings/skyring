...
func (a *App) LoadRoutes() {
	var routes = []CoreRoute{
		...
		},
		{
			...
			Method:      "GET",
			Pattern:     "clusters/{cluster-id}/monitoring",
			HandlerFunc: a.GET_MonitoringPlugins,
			Version:     1,
		},
		{
			Name:        "POST_EnableMonitoringPlugins",
			Method:      "POST",
			Pattern:     "clusters/{cluster-id}/monitoring/{plugin-name}/enable",
			HandlerFunc: a.POST_EnableMonitoringPlugins,
			Version:     1,
		},
		{
			Name:        "POST_DisableMonitoringPlugins",
			Method:      "POST",
			Pattern:     "clusters/{cluster-id}/monitoring/{plugin-name}/disable",
			HandlerFunc: a.POST_DisableMonitoringPlugins,
			Version:     1,
		},
		{
			Name:        "POST_Thresholds",
			Method:      "POST",
			Pattern:     "clusters/{cluster-id}/monitoring/thresholds",
		...
		},
		{
			...
			Method:      "DELETE",
			Pattern:     "clusters/{cluster-id}/monitoring/{plugin-name}",
