...
if ! yum -y install git golang salt-master python python-devel python-cpopen python-paramiko hg mongodb mongodb-server openldap-devel ceph http://influxdb.s3.amazonaws.com/influxdb-0.9.4.2-1.x86_64.rpm >/dev/null 2>&1; then
