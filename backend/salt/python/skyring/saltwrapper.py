...
def DisableMonitoringPlugin(nodes, pluginName):
    ...
    for node, restartStatus in out.iteritems():
        ...
        aggregatedRestartStatus = aggregatedRestartStatus and restartStatus
    print aggregatedRestartStatus
    if not aggregatedRestartStatus:
        return False
    else:
        return True
...
def UpdateMonitoringConfiguration(nodes, plugin_threshold_dict):
    ...
    for node, restartStatus in out.iteritems():
        aggregatedRestartStatus = aggregatedRestartStatus and restartStatus
    return aggregatedRestartStatus
