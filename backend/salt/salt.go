...
func (s Salt) ConfigureCollectdPhysicalResources(node string, pillar map[string]string) (success bool, err error) {
	if pyobj, err := pyFuncs["ConfigureCollectdPhysicalResources"].Call(node, pillar); err == nil {
