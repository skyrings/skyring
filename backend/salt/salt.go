...
func (s Salt) GetMetricValueFromCollectd(nodes []string, metricName string) (result map[string]map[string]string, err error) {
	result = make(map[string]map[string]string)
	mutex.Lock()
	defer mutex.Unlock()
	if pyobj, loc_err := pyFuncs["GetMetricValueFromCollectd"].Call(nodes, metricName); loc_err == nil {
